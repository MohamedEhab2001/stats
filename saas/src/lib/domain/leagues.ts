// Cosmetic league/cup names used to flavor auto-created tournaments. No tenant data lives here.

export type League = { id: number; name: string; category: string }
...
export function findLeague(id: number | null | undefined): League | null {
